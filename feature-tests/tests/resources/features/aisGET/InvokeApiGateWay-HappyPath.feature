Feature: Invoke-APIGateway-HappyPath.feature
    ...
    Scenario: Happy Path - Field Validation - Get Request to /ais/userId -  Multiple Transitions from one event type to other event types
        ...
        When I invoke an apiGateway to retreive the status of the invalid userId with history as true
        Then I should receive every transition event history data in the response for the ais endpoint


# Scenario: Happy Path - Field Validation - Get Request to /ais/userId -  Multiple Transitions from one event type to other event types
#     Given I send a "pswResetRequired" intervention message to the TxMA ingress SQS queue
#     And I invoke apiGateway to retreive the status of the valid userId with history value as true
#     Given I send an updated "suspendNoAction" intervention message to the TxMA ingress SQS queue
#     And I invoke apiGateway to retreive the status of the valid userId with history value as true
#     Given I send an updated "idResetRequired" intervention message to the TxMA ingress SQS queue
#     And I invoke apiGateway to retreive the status of the valid userId with history value as true
#     Given I send an updated "pswAndIdResetRequired" intervention message to the TxMA ingress SQS queue
#     And I invoke apiGateway to retreive the status of the valid userId with history value as true
#     Given I send an updated "block" intervention message to the TxMA ingress SQS queue
#     And I invoke apiGateway to retreive the status of the valid userId with history value as true
#     Given I send an updated "unblock" intervention message to the TxMA ingress SQS queue
#     And I invoke apiGateway to retreive the status of the valid userId with history value as true
#     Then I should receive every transition event history data in the response for the ais endpoint