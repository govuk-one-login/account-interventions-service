...
export enum EventsEnum {
  ...
  OPERATIONAL_FORCED_USER_IDENTITY_REVERIFICATION = 'OPERATIONAL_FORCED_USER_IDENTITY_REVERIFICATION',
  FRAUD_FORCED_USER_PASSWORD_RESET_AND_OPERATIONAL_IDENTITY_REVERIFICATION = 'FRAUD_FORCED_USER_PASSWORD_RESET_AND_OPERATIONAL_IDENTITY_REVERIFICATION', //pragma: allowlist secret
...
export enum TriggerEventsEnum {
  ...
  AUTH_PASSWORD_RESET_SUCCESSFUL = 'AUTH_PASSWORD_RESET_SUCCESSFUL', //pragma: allowlist secret
  AUTH_PASSWORD_RESET_SUCCESSFUL_FOR_TEST_CLIENT = 'AUTH_PASSWORD_RESET_SUCCESSFUL_FOR_TEST_CLIENT', //pragma: allowlist secret
  OPERATIONAL_ACCOUNT_INTERVENTION = 'OPERATIONAL_ACCOUNT_INTERVENTION',
}
