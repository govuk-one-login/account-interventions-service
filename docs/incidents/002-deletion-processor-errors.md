...
#### [2026-07-01]
[07:33] The `fpad-8283-account-status-typed-table-service` [PR](https://github.com/govuk-one-login/account-interventions-service/pull/1009) containing the bug is merged to `main` \
[08:26] [The `AccountDeletionProcessorErrorsOver10Mins` alarm fires](https://gds.slack.com/archives/C06R67X2EBC/p1782894367327679) \
[08:26] Edward Louth notices the alarm and writes [a Slack message](https://gds.slack.com/archives/C0AUW7NHFNE/p1782894412260269) \
[08:38] Edward Louth creates [a PR](https://github.com/govuk-one-login/account-interventions-service/pull/1045) with a fix \
[08:58] TSD write [a Slack message](https://gds.slack.com/archives/C02HCLREVV5/p1782896295394529) after noticing an uptick in the 4xx responses generated by the `AccountDeletionProcessor` Lambda. \
[09:03] The `FPAD-8434-deletion-conditional-check` fix branch is merged to `main` \
[09:46] The `AccountDeletionProcessorErrorsOver10Mins` alarm stops firing 
